...
subtitle: "Black Earth Restoration Collective (BERC) is a collective of Black, Indigenous, People of Color (BIPOC) restoration scientists and practitioners based in the tri-state area."
css: styles.css
---

#### Name Choice

Why did we choose the name for this website?

#### Purpose

As a collective, we hope to create a supportive and collaborative space for BIPOC researchers and practitioners to collaborate, hold discussions, and host in-person workshops for our community of BIPOC researchers and practitioners. 
...
::: {style="text-align: left"}
**Regina Mae Francia (PhD Candidate)** (she/her)\
**Northern Illinois University**\
:::

![](images/francia.jpeg){style="float: left; margin: 0px 15px 0px 0px;" fig-alt="headshot of Dr Becky Barak" fig-align="left" width="200"}
